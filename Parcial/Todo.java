...
public class Mapa {
    ...
    public ListaGenerica<String> primerCaminoRestringidos(Grafo<String> grafo,String origen, String destino, ListaGenerica<String> restringidas) {
      ...
      if (! (restringidas.incluye(origen) || restringidas.incluye(destino))){
        ...
        while (!restrigidas.fin()) {
          Vertice v = buscarVertice(grafo, restringidas.proximo());
          if (v!= null) {
    ...
    public class Resultado {
      ...
      public ListaGenerica<String> camino = new ListaEnlazadaGenerica();
  	...
  	private void dfs(Vertice<String> v, Grafo<String> grafo, String destino, boolean[] marcas, Resultado resultado, ListaGenerica<String> actual, int pesoAcumulado) {
