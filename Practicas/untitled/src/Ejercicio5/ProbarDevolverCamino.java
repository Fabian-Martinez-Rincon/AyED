package Ejercicio5;
import PackDeCosas.*;
public class ProbarDevolverCamino {
    public static void main(String[] args){
        ...
        ListaGenerica<String> camino = m.devolverCamino("1", "5");
        ...
        //PRUEBA2
        //Paso 1 - Creacion del Grafo
        Grafo<String> grafo2 = new GrafoImplListAdy<String>();
        ...
        ListaGenerica<String> camino2 = m2.devolverCamino("Buenos Aires","Cordoba");
